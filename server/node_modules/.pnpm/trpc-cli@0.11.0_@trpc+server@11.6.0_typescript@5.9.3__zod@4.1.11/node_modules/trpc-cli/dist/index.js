...
exports.CliValidationError = exports.FailedToExitError = exports.trpcCli = exports.parseRouter = exports.Command = exports.zod = exports.z = exports.trpcServer = void 0;
...
exports.trpcServer = "@deprecated use `import * as trpcServer from '@trpc/server'` instead";
/** @deprecated use `import {z} from "zod/v4"` instead (or use zod/v3 if you need to support use an old version of zod) */
exports.z = '@deprecated use `import {z} from "zod/v4"` instead (or use zod/v3 if you need to support use an old version of zod)';
/** @deprecated use `import {z} from "zod/v4"` instead (or use zod/v3 if you need to support use an old version of zod) */
exports.zod = '@deprecated use `import {z} from "zod/v4"` instead (or use zod/v3 if you need to support use an old version of zod)';
...
const parseOrpcRouter = (params) => {
    ...
    const { traverseContractProcedures, isProcedure } = require('@orpc/server');
        ...
        const configureCommand = (command, procedurePath, { meta, parsedProcedure, incompatiblePairs, procedure }) => {
            ...
            command.action(async (...args) => {
                ...
                if (deprecatedCreateCaller) {
                    ...
                    // eslint-disable-next-line @typescript-eslint/no-require-imports
                    const { call } = require('@orpc/server');
