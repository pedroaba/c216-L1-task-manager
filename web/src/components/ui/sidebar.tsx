...
// biome-ignore lint/style/noMagicNumbers: <we need to set the cookie max age>
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      setCookie(null, SIDEBAR_COOKIE_NAME, String(openState), {
        path: "/",
...
function SidebarMenuSkeleton({
  ...
  const width = React.useMemo(
    // biome-ignore lint/style/noMagicNumbers: <we need to generate a random width>
