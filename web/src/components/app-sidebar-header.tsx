        ...
        <SidebarMenuItem>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <SidebarMenuButton
                className={cn(
                  "group/trigger h-14 transition-all duration-200",
                  currentWorkspace
                    ? "hover:bg-sidebar-accent"
                    : "min-h-[60px] border border-zinc-300 border-dashed py-3 hover:border-zinc-400 hover:from-zinc-100 hover:to-zinc-200 hover:shadow dark:border-zinc-700 dark:from-zinc-800/30 dark:to-zinc-900/50 dark:hover:border-zinc-600 dark:hover:from-zinc-800/50 dark:hover:to-zinc-900/70"
                )}
                size="lg"
              >
                {currentWorkspace ? (
